...
- [ ] Проверить корректность всех alembic-миграций на чистой БД.
- [ ] Проверить bootstrap `automation_controls`.
- [ ] Убедиться, что уникальные/служебные индексы покрывают claim-сценарии.
