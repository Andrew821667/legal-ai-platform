...
- `[ ]` Синхронизировать ценовую и продуктовую модель между `lead-bot`, `web`, `contract-ai`.
- `[ ]` Зафиксировать 1-2 якорных продукта и выстроить позиционирование вокруг них.
