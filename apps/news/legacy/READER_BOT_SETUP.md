...
Reader Bot - персонализированный бот для читателей канала AI Verdict News. Позволяет:
...
2. Отправьте: `/newbot`
3. Введите название: `AI Verdict News Reader Bot`
...
6. Откройте любую карточку публикации:
   ...
   - `❓ Вопрос по статье` — подготовить черновик обращения в `Ассистент AI Verdict`
