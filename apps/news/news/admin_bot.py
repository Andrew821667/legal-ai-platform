...
_AUTO_QUEUE_FILTERS = ("all", "daily", "weekly_review", "longread", "practice", "other")
...
class NewsAdminBot:
    ...
    def _draft_post_with_llm(self, title: str, source_material: str, post_kind: str, *, source_mode: str = "ai", theme: str = "") -> str:
        ...
        system_prompt = (
            ...
            "Начни с предмета поста, а не с общего вступления. Чередуй короткие и средние фразы. "
            "Не повторяй один тезис в лиде и выводе, не выстраивай список из трех пунктов по привычке. "
            "Запрещены заготовки 'это не просто X, а Y', 'важно отметить', 'таким образом', "
            "'ключевой сдвиг', 'главный вывод' и слова-подпорки без факта: 'комплексный', 'трансформация', 'экосистема'. "
