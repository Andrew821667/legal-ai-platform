    ...
    def send_welcome_email(
        ...
        if is_demo:
            ...
            <div class="warning">
                ...
                <p>Если демо подтвердит полезность сценария, следующим шагом будет обсуждение пилота и рабочего контура.</p>
            </div>
            """
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p>Если хотите продолжить работу после демо, следующий шаг — согласовать пилотный или рабочий контур запуска.</p>
                    <p style="text-align: center;">
                        <a href="{upgrade_url}" class="button">Посмотреть форматы запуска</a>
                    </p>

                    <p>Не упустите возможность продолжить работу с системой!</p>

                    <p style="text-align: center;">
                        <a href="{upgrade_url}" class="button">Перейти к следующему этапу</a>
                    </p>

                    <p><strong>Следующий этап может включать:</strong></p>
                    <ul>
                        <li>Расширенный сценарий анализа под ваш процесс</li>
                        <li>Дополнительные режимы экспорта и согласования</li>
                        <li>Пилот на реальных документах и критериях качества</li>
                        <li>Поддержку и настройку рабочего контура</li>
                    </ul>
                </div>
                <div class="footer">
                    <p>© {datetime.now().year} Contract AI System. Все права защищены.</p>
