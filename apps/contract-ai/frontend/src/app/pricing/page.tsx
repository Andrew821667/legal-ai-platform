          ...
          <Card className="text-center bg-gradient-to-br from-primary-50 to-secondary-50 border-2 border-primary-200">
            <div className="py-6">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
                Если вы впервые в системе, начните с демо-контура: 3 договора бесплатно в месяц.
                Если уже проверили базовый сценарий, следующий разговор должен быть не про “тариф”,
                а про пилот и рабочий формат запуска.
              </p>
