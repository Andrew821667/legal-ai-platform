...
def build_welcome_message(first_name: str) -> str:
    ...
    return (
        ...
        "Помогаю быстро определить, где AI даст практический эффект: intake, договоры, комплаенс, legal ops.\n\n"
        "Опишите кейс в 1-2 предложениях: где узкое место и какой результат нужен.\n\n"
        "Если нужно передать вопрос лично, нажмите «✉️ Личное обращение»."
    )
