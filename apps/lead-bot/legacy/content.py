...
PLATFORM_PARTS_TEXT = (
    ...
    "• ⚖️ юридическая помощь — быстро передать правовую задачу юристу\n"
    "• 📰 канал и reader-бот — разборы Legal AI и персональная лента\n"
    "• 📱 Mini App — контент, инструменты, профиль и заявка внутри Telegram"
)

PLATFORM_CONTEXT_TEXT = (
    "<b>AI Verdict</b> — это единая платформа для юридической AI-работы, "
    "а не отдельный бот. Можно начинать с любого элемента, потому что контекст "
    "и заявки внутри платформы не теряются."
)
...
MODULE_CATALOG = {
    ...
    "legal_help": "Юридическая помощь: договоры, претензии, суды и другие правовые задачи",
    "custom_integrations": "Разработка и интеграции: боты, сайты, Mini App, программы, AI-модули, CRM/ERP/1C/ЭДО",
}
...
def _platform_services_text(platform_key: str) -> str:
    ...
    return (
        ...
        f"{bullets}\n\n"
        "<b>Также доступны отдельными маршрутами:</b>\n"
        "• юридическая помощь бизнесу, ИП и частным клиентам — задачу получает юрист\n"
        "• разработка для результата или другой цели: бот, сайт, Mini App, внутренняя программа, "
        "AI-модуль, сервис или интеграция\n\n"
...
def assistant_chat_hint_text() -> str:
    return (
        ...
        "• <i>«нужен бот, сайт или внутренняя программа для другой задачи»</i>"
    )
...
def build_welcome_message(first_name: str) -> str:
    ...
    return (
        ...
        "Дополнительно можно передать юристу обычную правовую задачу. А если для результата "
        "или другой цели нужен бот, сайт, Mini App, внутренняя программа, AI-модуль или интеграция, "
        "мы можем спроектировать и запустить это тоже.\n\n"
...
def build_start_entry_text(
    ...
    *,
    ...
    return (
        ...
        "Также оказываем юридическую помощь бизнесу и частным клиентам. Если для результата "
        "или другой цели нужен бот, сайт, Mini App, внутренняя программа, AI-модуль или интеграция, "
        "можем спроектировать и запустить это тоже.\n\n"
        "<b>Вам доступен весь контур платформы:</b>\n"
        f"{PLATFORM_PARTS_TEXT}\n\n"
        f"{profile_hint}"
        "<b>С чего удобно начать:</b>\n"
        "1. <b>🧪 Проверить договор</b> — если у вас уже есть документ\n"
        "2. <b>⚖️ Юридическая помощь</b> — если правовую задачу нужно передать юристу\n"
        "3. <b>🛠 Разработка</b> — если нужен бот, сайт, программа, AI-модуль или интеграция\n"
...
HELP_MESSAGE = (
    ...
    "передать юристу обычную правовую задачу или обсудить разработку бота, сайта, Mini App, "
    "внутренней программы и интеграции для другой цели.\n\n"
    ...
    "<i>«нужен Telegram-бот для другой задачи»</i>.\n\n"
    f"{legal_disclaimer_short_text()}"
)
...
def build_workspace_text(
    ...
    return (
        ...
        "консультация, документы и переходы к связанным контурам.\n"
        ...
        "• передать правовую задачу юристу\n"
        "• обсудить разработку бота, сайта, Mini App, программы, AI-модуля или интеграции\n\n"
...
MENU_RESPONSES = {
    ...
    "menu_help": (
        ...
        "• передаю обычные правовые задачи юристу\n"
        "• принимаю запросы на ботов, сайты, Mini App, программы, AI-модули и интеграции\n"
        ...
        "«нужен сайт или бот для другой цели»\n"
        "«хотим внедрить ИИ в юридическую функцию»."
    ),
    "menu_custom_development": (
        "<b>🛠 Разработка и интеграции</b>\n\n"
        "Основное направление AI Verdict — автоматизация юридических бизнес-процессов и их "
        "интеграция с действующими системами.\n\n"
        "Если для результата или другой цели нужен Telegram-бот, сайт, Mini App, личный кабинет, "
        "внутренняя программа, AI-модуль, сервис или интеграция с CRM/ERP/1C/ЭДО, мы можем "
        "спроектировать и запустить это тоже.\n\n"
