...
def build_welcome_message(first_name: str) -> str:
    ...
    return (
        ...
        "<b>AI Verdict</b> — это полноценная платформа и ИИ-помощник "
        "по автоматизации юридических процессов.\n"
        ...
        "Можно пользоваться всеми элементами платформы: сайтом, Contract AI, "
        "этим ассистентом, новостным контуром и Mini App.\n\n"
...
def build_start_entry_text(
    ...
    *,
    ...
    return (
        ...
        "Можно пользоваться всем контуром: сайтом, Contract AI, этим ассистентом, "
        "новостями и Mini App. Начните там, где сейчас удобнее, а контекст не потеряется.\n\n"
        f"{profile_hint}"
