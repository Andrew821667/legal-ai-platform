...
PRACTICES_TEXT = (
    "<b>В AI Verdict работают три специализированных направления:</b>\n"
    "1. <b>Автоматизация юридической функции</b> — основная практика: legal-процессы, AI и интеграции\n"
    "2. <b>Юридическая практика</b> — договоры, споры и другие правовые задачи\n"
    "3. <b>Инженерная практика</b> — боты, сайты, Mini App, программы, AI-модули и интеграции\n\n"
...
def _platform_services_text(platform_key: str) -> str:
    ...
    return (
        ...
        f"{bullets}\n\n"
        "<b>Отдельные специализированные практики:</b>\n"
...
def build_welcome_message(first_name: str) -> str:
    ...
    return (
        ...
        "Основная практика помогает внедрять ИИ в <b>юридические бизнес-процессы</b>: "
...
HELP_MESSAGE = (
    ...
    f"{PLATFORM_PARTS_TEXT}\n\n"
    "Я помогаю выбрать профильное направление: <b>автоматизацию юридической функции</b>, "
    "юридическую практику или инженерную практику разработки и интеграций.\n\n"
...
def build_workspace_text(
    ...
    return (
        ...
        "• передать правовую задачу отдельной юридической практике\n"
        "• передать разработку отдельной инженерной практике\n\n"
...
MENU_RESPONSES = {
    ...
    "menu_custom_development": (
        ...
        "Отдельная инженерная практика рассматривает задачи разработки Telegram-ботов, сайтов, "
        "Mini App, личных кабинетов, внутренних программ, AI-модулей, сервисов и интеграций "
        "с CRM/ERP/1C/ЭДО, в том числе вне legal-контура.\n\n"
