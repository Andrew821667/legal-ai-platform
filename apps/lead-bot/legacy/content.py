...
def build_welcome_message(first_name: str) -> str:
    ...
    return (
        ...
        "<b>Legal AI PRO</b> помогает юристам и бизнесу <b>быстрее разбирать договоры</b>, "
        "<b>не терять юридические запросы</b> и <b>снимать ручную рутину</b> с помощью автоматизации и ИИ.\n\n"
        "<b>О чем это на практике:</b>\n"
        "• долго согласуются договоры\n"
        "• теряются запросы от бизнеса\n"
        "• слишком много ручной переписки и однотипных действий\n"
        "• нужен понятный первый шаг по автоматизации юридической работы\n\n"
        "<b>Если вы только знакомитесь с темой, это нормально.</b>\n"
        "Можно начать без специальных терминов: посмотреть услуги, цены, выбрать свой профиль "
        "или просто описать проблему обычными словами.\n\n"
...
def build_business_welcome_message(first_name: str) -> str:
    return (
        ...
        "<b>Для быстрого старта:</b> используйте кнопки ниже "
...
def build_workspace_text(
    ...
    return (
        "<b>🧭 Рабочий стол</b>\n\n"
        f"{intro}"
        "Если вы здесь впервые, начните с верхней кнопки <b>«🎯 Профиль услуг»</b>. "
...
MENU_RESPONSES = {
    "menu_services": (
        ...
        "Это основные форматы работы. Если не уверены, какой из них ваш, начните с <b>профиля услуг</b> или <b>консультации</b>."
    ),
    "menu_prices": (
    ...
    "menu_contract_ai": (
        ...
        "<b>Contract_AI_System</b> — это наш отдельный сервис для работы с договорами.\n\n"
        "<b>Он помогает:</b>\n"
