...
def assistant_chat_hint_text() -> str:
    return (
        "<u><b>Можно просто написать задачу боту.</b></u>\n"
        "<i>Например: «хотим внедрить ИИ в договорную работу» "
        "или «юристы тонут во входящих запросах».</i>"
    )
...
def build_welcome_message(first_name: str) -> str:
    ...
    return (
        ...
        "Например: <i>«хотим внедрить ИИ в договорную работу»</i> или "
        "<i>«у нас теряются запросы к юристам»</i>.\n\n"
...
def build_start_entry_text(
    ...
    *,
    ...
    return (
        ...
        "Можно не ждать подходящей кнопки: просто напишите, что хотите автоматизировать, "
        "и я предложу следующий шаг.\n\n"
        f"{legal_disclaimer_short_text()}"
    )
...
MENU_RESPONSES = {
    ...
    "menu_contract_ai": (
        ...
        "Это хороший вход, если хотите быстро увидеть, как ИИ помогает в договорной работе на живом примере.\n"
