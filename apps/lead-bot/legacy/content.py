...
PRACTICES_TEXT = (
    "<b>AI Verdict объединяет две базовые практики:</b>\n"
    ...
    "<b>На их стыке</b> мы автоматизируем юридическую функцию: соединяем legal-процессы, AI и системы компании.\n\n"
    "Запрос сразу направляется команде с нужной специализацией."
)

PLATFORM_CONTEXT_TEXT = (
    "<b>AI Verdict</b> — это единая платформа юридической и инженерной практик, "
...
def build_welcome_message(first_name: str) -> str:
    ...
    return (
        ...
        "На стыке двух практик мы внедряем ИИ в <b>юридические бизнес-процессы</b>: "
