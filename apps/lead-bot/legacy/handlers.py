    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            welcome_message = (
                ...
                "Я ассистент платформы AI Verdict — единого контура для юридической AI-работы.\n\n"
                "В платформе доступны сайт, Contract AI для проверки договоров, этот ассистент, "
                "канал с разборами, reader-бот и Mini App. Можно начинать с любого элемента: "
                "контекст и заявки не теряются.\n\n"
                "Расскажите задачу обычными словами или откройте нужный раздел."
            )
