...
AI Verdict объединяет две базовые практики — юридическую и инженерную.
...
Автоматизацию юридической функции объясняй как ключевое пересечение двух практик, а не как третью практику.
""".strip()
