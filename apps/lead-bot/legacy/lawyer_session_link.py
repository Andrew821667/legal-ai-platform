...
Внутри Telegram initData есть всегда, пока страница открыта в его WebView.
Вне Telegram (иконка на экране iPhone, обычная вкладка Safari) её нет вовсе —
эту дверь бот открывает сам, выдавая подписанную ссылку по запросу владельца.
