    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Полезный маршрут разделяет факты из документа, правила проверки и сгенерированный текст. Тогда юрист видит не только вывод, но и фрагмент, из которого он получен, а также понимает, что именно нужно подтвердить вручную.",
        ],
      },
      {
