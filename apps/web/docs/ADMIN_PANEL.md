...
Полнофункциональная админ-панель для мониторинга и управления сайтом AI Verdict.
...
Часть проекта AI Verdict. См. основной [LICENSE](../LICENSE)

---

**Создано с ❤️ для AI Verdict**
