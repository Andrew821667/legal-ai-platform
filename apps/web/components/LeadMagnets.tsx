...
export default function LeadMagnets() {
  ...
  const magnets = [
    ...
    {
      icon: "📄",
      title: "Гайд по внедрению ИИ в юр.отдел",
    ...
    {
      icon: "🎯",
      title: "Демонстрационный разбор договора",
    ...
    {
      icon: "🧾",
      title: "Пример отчета по договору",
      subtitle: "Структура результата",
      description:
        "Получите пример отчета по договору: карта рисков, приоритеты правок и формат следующего шага к пилоту.",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={headerRef} className={`text-center mb-16 scroll-reveal ${headerVisible ? 'visible' : ''}`}>
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Выберите удобный бесплатный формат: консультация, гайд или демонстрационный разбор договора.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl text-slate-300 mb-6 max-w-2xl mx-auto">
              Без обязательств и скрытых платежей. Следующий платный шаг, если он нужен, обсуждаем отдельно как пилот или внедрение.
            </p>
