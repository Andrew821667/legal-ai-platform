...
const principles = [
  ...
  },
  {
    ...
    text: "Разбираем весь рабочий процесс: маршрут заявки, договорный поток, комплаенс, сроки и ежедневную работу команды.",
  },
];

export default function TrustSignals() {
  return (
    <section id="trust" className="py-16 bg-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-300 max-w-3xl mx-auto">
            Скорость полезна, пока под контролем остаются риски, данные и ответственность за решение.
          </p>
        </div>
