...
export default function Features() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: `Сами проектируем backend, ботов, сайты, mini app, интеграции и внутренние панели.
        Поэтому можем закрыть не только legal-логику, но и весь технический контур вокруг нее.`,
    },
    {
      icon: Flag,
