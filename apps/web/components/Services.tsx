  ...
  const services = [
    {
      ...
      description: "Помогаем ускорить первый проход по договору, выстроить правила проверки и упростить согласование.",
      price: "Формат и бюджет — после оценки",
    ...
    },
    {
      ...
      description: "Упрощаем сбор практики, подготовку типовых документов и контроль событий по делам.",
      price: "Формат и бюджет — после оценки",
    ...
    },
    {
      ...
      description: "Настраиваем предварительный обзор документов и структурированный first-pass для корпоративного блока и сделок.",
      price: "Формат и бюджет — после оценки",
      sources: ["ФЗ об ООО", "ФЗ об Акционерных обществах", "Реестр ЕГРЮЛ"],
      features: [
        "First-pass корпоративных документов",
        "Анализ уставов",
        "Сделки M&A",
        "Реестр акционеров",
      ],
    ...
    },
    {
      ...
      description: "Помогаем быстрее разбирать земельные документы, ограничения и историю объекта.",
      price: "Формат и бюджет — после оценки",
    ...
    },
    {
      icon: ShieldCheck,
      title: "Комплаенс",
      description: "Настраиваем мониторинг изменений и рабочий контур контроля для комплаенса и внутренних правил.",
      price: "Формат и бюджет — после оценки",
      sources: ["КоАП РФ", "Методические рекомендации ЦБ РФ", "ФЗ о противодействии коррупции"],
      features: [
        "Мониторинг по сценарию",
        "Антикоррупция",
    ...
    },
    {
      ...
      description: "Пишем ботов, сайты, mini app, внутренние сервисы и интеграции с 1С, CRM, ERP, ЭДО и базами данных.",
      price: "Формат и бюджет — после оценки",
      sources: ["Техническая документация API", "Требования безопасности и доступа", "GDPR/152-ФЗ"],
      features: [
    ...
    },
    {
      ...
      features: [
        "Мониторинг изменений по сценарию",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={headerRef} className={`text-center mb-16 scroll-reveal ${headerVisible ? 'visible' : ''}`}>
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Автоматизация юридической функции и сопутствующая разработка: от договоров и legal ops
            до ботов, сайтов, интеграций и внутренних бизнес-приложений.
          </p>
        </div>
