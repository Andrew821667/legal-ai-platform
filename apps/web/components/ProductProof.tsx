      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h2 id="product-proof-title" className="mt-2 text-3xl font-semibold text-white md:text-4xl">
            Что уже можно открыть и проверить
          </h2>
          <p className="mt-4 text-slate-300">
            Здесь собраны действующие части платформы. Можно посмотреть интерфейсы, пройти пользовательский маршрут и
            понять, как решение выглядит в работе.
          </p>
        </div>
