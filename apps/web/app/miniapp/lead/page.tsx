      ...
      <form onSubmit={onSubmit} className="space-y-4">
        <label className="block">
          ...
          <input
            ...
            placeholder="Андрей"
            className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2.5 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/40"
          />
        </label>
        ...
        <label className="block">
          ...
          <select
            ...
            className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2.5 text-slate-100 focus:outline-none focus:ring-2 focus:ring-amber-500/40"
          >
