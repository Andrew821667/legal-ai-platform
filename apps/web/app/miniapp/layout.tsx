          ...
          <div className="mb-5 rounded-xl border border-slate-800 bg-slate-900/70 p-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Link
                ...
                className="inline-flex w-full items-center justify-center rounded-lg bg-amber-500 px-3 py-2 text-center text-xs font-semibold text-slate-950 transition-colors hover:bg-amber-400 sm:w-auto"
              >
                Проверить договор
              </Link>
            </div>
