...
const outcomes = [
  ...
  "Автоматизация смежных процессов: CRM, ERP, боты, сайты, внутренние сервисы и отчеты",
];
...
const audiences = [
  ...
  },
  {
    ...
    details: "Ускорение договорных циклов, интеграции с CRM/ERP и снижение потерь на межфункциональных согласованиях.",
  },
  {
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            {audiences.map((audience) => (
              <article key={audience.title} className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
