...
export const metadata: Metadata = {
  ...
  description:
    "Автоматизируем юридическую работу, оказываем юридическую помощь и создаем прикладные программные системы.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Автоматизация юридической работы, юридическая помощь и прикладная разработка.",
    siteName: "AI Verdict",
    images: [
      {
