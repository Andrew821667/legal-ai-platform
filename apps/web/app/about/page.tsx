      ...
      <section className="relative overflow-hidden border-b border-slate-700">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-14">
          ...
          <p className="mt-5 max-w-3xl text-slate-300 text-lg leading-relaxed">
            Юристы отвечают за правовую логику и риски. Инженеры — за архитектуру, данные и надежность. Вместе они
            автоматизируют юридические процессы; отдельные правовые и программные задачи ведут профильные команды.
          </p>
        </div>
      </section>
