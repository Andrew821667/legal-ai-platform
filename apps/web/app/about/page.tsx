...
export const metadata: Metadata = createPageMetadata({
  title: "О платформе: юридическая и инженерная практики",
  description:
    "AI Verdict объединяет юридическую и инженерную практики. На их стыке команда автоматизирует юридическую функцию и внедряет Legal AI.",
  path: "/about",
});
    ...
    <main className="bg-slate-900 text-slate-100 min-h-screen">
      <section className="relative overflow-hidden border-b border-slate-700">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-14">
          ...
          <h1 className="mt-5 text-4xl md:text-5xl font-semibold text-white leading-tight">AI Verdict: юридическая и инженерная практики</h1>
          <p className="mt-5 max-w-3xl text-slate-300 text-lg leading-relaxed">
            Юристы определяют правовую логику, риски и контрольные точки, инженеры превращают процесс в устойчивую
            систему. На пересечении этих практик мы автоматизируем юридическую функцию; самостоятельно каждая команда
            ведет профильные юридические или инженерные проекты.
          </p>
        </div>
      </section>
