        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8 bg-white rounded-xl p-8 shadow-sm">
            ...
            <p className="text-slate-700 mb-4">
              ...
              ИНН <strong>{LEGAL_OPERATOR_INN}</strong>,
          ...
          <section className="mb-8 bg-white rounded-xl p-8 shadow-sm">
            ...
            <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-2">
              ...
              <li>Реквизиты документа, удостоверяющего личность, если вы подписываете NDA или договор</li>
            </ul>
          ...
          <section className="mb-8 bg-white rounded-xl p-8 shadow-sm">
            ...
            <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-2">
              ...
              <li><strong>Оформление документов:</strong> идентификация клиента, подписание NDA и договора, подтверждение юридически значимых действий</li>
          ...
          <section className="mb-8 bg-white rounded-xl p-8 shadow-sm">
            ...
            <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-2">
              ...
              <li><strong>Подписанные NDA, договоры и подтверждения согласия:</strong> в течение срока, необходимого для исполнения обязательств, обязательного хранения и защиты прав сторон</li>
          ...
          <section className="mb-8 bg-white rounded-xl p-8 shadow-sm">
            ...
            <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-2">
              ...
              <li><strong>Отзыв согласия:</strong> в любой момент отозвать согласие на обработку данных; после отзыва обработка прекращается, кроме случаев, когда её продолжение требуется по закону или для защиты прав сторон</li>
